...
const PokemonList: FC<PokemonListProps> = ({ setQueue }) => {
    ...
    return (
        <div className="absolute z-20 top-5 flex w-fit flex-row items-center justify-center gap-2 px-4 md:right-0 md:top-[50%] md:translate-y-[-50%] md:flex-col md:justify-end md:gap-5 md:px-0">
            {offset > 0 && (
